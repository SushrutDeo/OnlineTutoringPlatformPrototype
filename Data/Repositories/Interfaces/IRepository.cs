...
namespace OnlineTutoringPlatformPrototype.Data.Repositories.Interfaces
{
	/// <summary>
	/// Generic repository interface that provides a service contract of a functionality to perform CRUD opertations
	/// on any concrete repository
	/// </summary>
	...
	public interface IRepository<TEntity> where TEntity : EntityBase
	{
		...
		/// <returns></returns>
		Task<TEntity> GetAsync(ExpressionStarter<TEntity> filter,
		...
		/// <param name="includes"></param>
		/// <returns></returns>
		Task<Tuple<IEnumerable<TEntity>, int>> GetAllAsync(ExpressionStarter<TEntity> filter, int totalRecordsCount,
